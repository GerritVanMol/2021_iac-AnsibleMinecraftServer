...
== Scenario
* link:Intro_Project.adoc[Kennismaking]

* link:vmware.adoc[Intro VM's]

* link:AnsibleIntro.adoc.adoc[Intro Ansible]

* link:Ansible_in_depth.adoc[Uitgebreid Ansible]

* link:deployingMC.adoc[Minecraft deployen met Ansible ]
